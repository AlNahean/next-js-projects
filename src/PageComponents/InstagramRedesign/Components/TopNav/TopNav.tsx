    ...
    <>
      <div className="flex flex-wrap">
        <div className="w-full ">
          <nav className="relative flex flex-wrap items-center justify-between py-4  rounded-xl ">
            <div className="container mx-auto flex flex-wrap items-center justify-between">
              ...
              <div className=" relative flex justify-start   ">
                ...
                <div className=" flex items-center ">
                  ...
                  <div className="relative hidden  xl:flex w-full flex-wrap items-center  bg-zinc-700 bg-opacity-60 rounded-lg  ">
                    <div className="z-10 h-100 leading-snug font-normal  text-center text-slate-300 absolute bg-transparent rounded text-base items-center justify-center w-8 right-0  mr-3">
                    ...
                    <input
                      type="text"
                      placeholder="Search"
                      className="px-3 py-3  placeholder-slate-300 text-slate-300 relative rounded-lg text-sm  outline-none focus:outline-none focus:ring-0 pr-10 bg-transparent w-[450px]"
                    />
                  </div>
                </div>
              ...
              >
                <ul className="flex flex-row list-none ml-auto">
                  <li className="nav-item  center  hidden  sm:flex">
                  ...
                  <li className="nav-item">
                    <div className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75">
                      <button className=" px-3 py-1 flex items-center bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 rounded-lg">
                        <div className=" text-2xl h-100 w-100 center">
                          <AiFillPlusCircle />
                        </div>
                        <h5 className=" p-2">Add Post</h5>
                      </button>
                    </div>
                  </li>
                </ul>

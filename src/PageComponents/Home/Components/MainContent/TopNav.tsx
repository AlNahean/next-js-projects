                ...
                <div className=" flex items-center">
                  ...
                  <div className="relative hidden  xl:flex w-full flex-wrap items-center ml-4 ">
                    <input
                      type="text"
                      placeholder="Search"
                      className="px-3 py-3 placeholder-slate-300 text-slate-300 relative rounded-full text-sm border border-slate-300 outline-none focus:outline-none focus:ring-0 pr-10 bg-transparent w-[450px]"
                    />
